...
Namespace PFW.CSIST203.Project1.Tests
    ...
    Public MustInherit Class TestBase
        ...
        ''' <param name="cleanWorkingDirectory"></param>
        ''' <returns></returns>
        Protected Function GetCleanWorkingTestDirectory(depth As Integer, cleanWorkingDirectory As Boolean)
            Return GetCleanWorkingTestDirectory(
                System.IO.Path.GetDirectoryName(System.AppDomain.CurrentDomain.SetupInformation.ConfigurationFile),
                depth,
                cleanWorkingDirectory
        ...
        ''' <param name="cleanWorkingDirectory"></param>
        ''' <returns></returns>
        Protected Function GetCleanWorkingTestDirectory(baseDirectory As String, depth As Integer, cleanWorkingDirectory As String) As String
        ...
        ''' <param name="cleanWorkingDirectory"></param>
        ''' <returns></returns>
        Protected Function GetCleanWorkingTestDirectory(baseDirectory As String, depth As Integer, cleanWorkingDirectory As String, setWorkingDirectory As Boolean) As String
